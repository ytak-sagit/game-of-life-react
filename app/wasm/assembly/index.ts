...
// 上端か否か
function isUpEdge(index: i32, width: i32): bool {
  return index < width;
}

// 下端か否か
function isDownEdge(index: i32, width: i32, height: i32): bool {
  return width * (height - 1) <= index;
}

// 左端か否か
function isLeftEdge(index: i32, width: i32): bool {
  return index % width === 0;
}

// 右端か否か
function isRightEdge(index: i32, width: i32): bool {
